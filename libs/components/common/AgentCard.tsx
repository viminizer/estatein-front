...
interface AgentCardProps { agent: any;
          ...
          <Box component={'div'} className={'buttons'}>
            ...
            <IconButton color={'default'}>
              {agent?.meLiked && agent?.meLiked[0]?.myFavorite ? (
                <FavoriteIcon color={'primary'} onClick={() => likeMemberHandler(user, agent._id)} />
              ) : (
                <FavoriteBorderIcon onClick={() => likeMemberHandler(user, agent._id)} />
              )}
            </IconButton>
